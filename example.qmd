...
Display {{< indexer add this idxdisplay='' idxsee='that' >}} word, and add *see* *that* word.

or

Display {{< indexer_add_term this idxdisplay='' idxsee='that' >}} word, and add *see* *that* word.
